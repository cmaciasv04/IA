...
if ($search !== null) {
    $sql .= " WHERE nombre_prov LIKE '%$search%' OR cedula_prov LIKE '%$search%'";
}
...
if ($resultado->num_rows > 0) {
    ...
    echo "<thead><tr><th>Nombre</th><th>Cedula</th><th>Teléfono</th><th>Email</th><th>Detalle</th></tr></thead>";
    echo "<tbody>";
    while ($fila = $resultado->fetch_assoc()) {
        echo "<tr>";
    
        echo "<td>" . $fila['nombre_prov'] . "</td>";
        echo "<td>" . $fila['cedula_prov'] . "</td>";
        echo "<td>" . $fila['telf_prov'] . "</td>";
        echo "<td>" . $fila['email_prov'] . "</td>";
      // Dentro del while loop que muestra los proveedores
         echo "<td><a href='det_proveedor.php?id=" . $fila['nombre_prov'] . "'><button>Revisar</button></a></td>";
